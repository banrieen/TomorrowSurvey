...
![](static/quickStart/image9.png)

*系统弹出如图所示页面，将代码工程相关文件上传至开发环境中。支持的文件类型包括：代码文件，zip压缩包和rar压缩包。*

![](static/quickStart/image10.png)
...
![](static/quickStart/image17.png)

2.  Jupyter Notebook交互式界面

![](static/quickStart/image18.png)
...
![](static/quickStart/image19.png)

2.  添加SSH信息

![](static/quickStart/image20.png)

3.  输入SSH信息

![](static/quickStart/image21.png)

4.  打开Remote SSH环境

![](static/quickStart/image22.png)

5.  填写对应SSH登录密码

![](static/quickStart/image23.png)

6.  选择开发目录

![](static/quickStart/image24.png)
